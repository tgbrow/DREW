...
class Ui_MainScreen(object):
    def setupUi(self, MainScreen):
        ...
        self.tableStatus.setGeometry(QtCore.QRect(10, 10, 450, 281))
        ...
        self.tableStatus.verticalHeader().setDefaultSectionSize(25)
        self.tableStatus.verticalHeader().setMinimumSectionSize(25)
        self.tableStatus_2 = QtWidgets.QTableWidget(self.tabStatus)
        self.tableStatus_2.setGeometry(QtCore.QRect(10, 310, 450, 281))
        self.tableStatus_2.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.tableStatus_2.setAlternatingRowColors(False)
        self.tableStatus_2.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableStatus_2.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tableStatus_2.setObjectName("tableStatus_2")
        self.tableStatus_2.setColumnCount(2)
        self.tableStatus_2.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableStatus_2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableStatus_2.setHorizontalHeaderItem(1, item)
        self.tableStatus_2.horizontalHeader().setDefaultSectionSize(224)
        self.tableStatus_2.horizontalHeader().setSortIndicatorShown(False)
        self.tableStatus_2.horizontalHeader().setStretchLastSection(True)
        self.tableStatus_2.verticalHeader().setDefaultSectionSize(25)
        self.tableStatus_2.verticalHeader().setMinimumSectionSize(25)
    ...
    def retranslateUi(self, MainScreen):
        ...
        item = self.tableStatus_2.horizontalHeaderItem(0)
        item.setText(_translate("MainScreen", "Device"))
        item = self.tableStatus_2.horizontalHeaderItem(1)
