...
class Ui_MainScreen(object):
    def setupUi(self, MainScreen):
        ...
        self.tableZoneOccupation = QtWidgets.QTableWidget(self.tabStatus)
        self.tableZoneOccupation.setGeometry(QtCore.QRect(10, 10, 450, 281))
        self.tableZoneOccupation.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.tableZoneOccupation.setAlternatingRowColors(False)
        self.tableZoneOccupation.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableZoneOccupation.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tableZoneOccupation.setObjectName("tableZoneOccupation")
        self.tableZoneOccupation.setColumnCount(2)
        self.tableZoneOccupation.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableZoneOccupation.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableZoneOccupation.setHorizontalHeaderItem(1, item)
        self.tableZoneOccupation.horizontalHeader().setDefaultSectionSize(224)
        self.tableZoneOccupation.horizontalHeader().setSortIndicatorShown(False)
        self.tableZoneOccupation.horizontalHeader().setStretchLastSection(True)
        self.tableZoneOccupation.verticalHeader().setVisible(False)
        self.tableZoneOccupation.verticalHeader().setDefaultSectionSize(25)
        self.tableZoneOccupation.verticalHeader().setMinimumSectionSize(25)
        self.tableDeviceState = QtWidgets.QTableWidget(self.tabStatus)
        self.tableDeviceState.setGeometry(QtCore.QRect(10, 310, 450, 281))
        self.tableDeviceState.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.tableDeviceState.setAlternatingRowColors(False)
        self.tableDeviceState.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableDeviceState.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tableDeviceState.setObjectName("tableDeviceState")
        self.tableDeviceState.setColumnCount(2)
        self.tableDeviceState.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableDeviceState.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableDeviceState.setHorizontalHeaderItem(1, item)
        self.tableDeviceState.horizontalHeader().setDefaultSectionSize(224)
        self.tableDeviceState.horizontalHeader().setSortIndicatorShown(False)
        self.tableDeviceState.horizontalHeader().setStretchLastSection(True)
        self.tableDeviceState.verticalHeader().setVisible(False)
        self.tableDeviceState.verticalHeader().setDefaultSectionSize(25)
        self.tableDeviceState.verticalHeader().setMinimumSectionSize(25)
        ...
        self.tableWearable.verticalHeader().setDefaultSectionSize(25)
        self.tableWearable.verticalHeader().setMinimumSectionSize(25)
        ...
        self.tableDevice.verticalHeader().setDefaultSectionSize(25)
        self.tableDevice.verticalHeader().setMinimumSectionSize(25)
        ...
        self.tableZone.verticalHeader().setDefaultSectionSize(25)
        self.tableZone.verticalHeader().setMinimumSectionSize(25)
        ...
        self.tableConfig.verticalHeader().setDefaultSectionSize(25)
        self.tableConfig.verticalHeader().setMinimumSectionSize(25)
    ...
    def retranslateUi(self, MainScreen):
        ...
        item = self.tableZoneOccupation.horizontalHeaderItem(0)
        item.setText(_translate("MainScreen", "Zone"))
        item = self.tableZoneOccupation.horizontalHeaderItem(1)
        item.setText(_translate("MainScreen", "Wearables Present"))
        item = self.tableDeviceState.horizontalHeaderItem(0)
        item.setText(_translate("MainScreen", "Device"))
        item = self.tableDeviceState.horizontalHeaderItem(1)
        item.setText(_translate("MainScreen", "Current State"))
        ...
        item.setText(_translate("MainScreen", "Bluetooth Address"))
