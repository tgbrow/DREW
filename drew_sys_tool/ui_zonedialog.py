...
class Ui_ZoneDialog(object):
    def setupUi(self, ZoneDialog):
        ...
        self.labelInvalidName = QtWidgets.QLabel(ZoneDialog)
        ...
        self.labelInvalidModule = QtWidgets.QLabel(ZoneDialog)
        self.labelInvalidModule.setGeometry(QtCore.QRect(20, 150, 271, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.labelInvalidModule.setFont(font)
        self.labelInvalidModule.setStyleSheet("color: rgb(255, 0, 0);")
        self.labelInvalidModule.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.labelInvalidModule.setObjectName("labelInvalidModule")
    ...
    def retranslateUi(self, ZoneDialog):
        ...
        self.labelInvalidName.setText(_translate("ZoneDialog", "Name already in use -- cannot save."))
        self.labelInvalidModule.setText(_translate("ZoneDialog", "Invalid zone module -- cannot save."))
