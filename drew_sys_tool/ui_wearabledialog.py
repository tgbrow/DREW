...
class Ui_WearableDialog(object):
    def setupUi(self, WearableDialog):
        ...
        self.labelInvalidWearable = QtWidgets.QLabel(WearableDialog)
        self.labelInvalidWearable.setGeometry(QtCore.QRect(20, 150, 271, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.labelInvalidWearable.setFont(font)
        self.labelInvalidWearable.setStyleSheet("color: rgb(255, 0, 0);")
        self.labelInvalidWearable.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.labelInvalidWearable.setObjectName("labelInvalidWearable")
        self.labelInvalidName = QtWidgets.QLabel(WearableDialog)
    ...
    def retranslateUi(self, WearableDialog):
        ...
        self.labelInvalidWearable.setText(_translate("WearableDialog", "Invalid wearable unit -- cannot save."))
        self.labelInvalidName.setText(_translate("WearableDialog", "Name already in use -- cannot save."))
